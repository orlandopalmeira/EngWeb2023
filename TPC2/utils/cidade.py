class Cidade:
    ...
    def __eq__(self, other):
        if isinstance(other, Cidade):
            return self.id == other.id and self.nome == other.nome and self.populacao == other.populacao\
                   and self.descricao == other.descricao and self.distrito == other.distrito and self.ligacoes == other.ligacoes
        return False
